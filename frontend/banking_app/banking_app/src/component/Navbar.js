        ...
        <>
            <nav className="navbar navbar-expand-lg navbar-light bg-primary mynav">
                <div className="container-fluid">
                    <a className="navbar-brand text-white" href="/"><i class="fa-solid fa-building-columns"></i> E-Banking System</a>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        }
                        {
                            !loginUser && <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                                ...
                                <li className="nav-item">
                                    <Link to="netbanking" className="nav-link active" > NET BANKING</Link>
                                </li>
